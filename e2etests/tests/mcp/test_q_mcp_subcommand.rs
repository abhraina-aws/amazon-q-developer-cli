...
fn test_q_mcp_help_subcommand() -> Result<(), Box<dyn std::error::Error>> {
    println!("\n🔍 Testing kiro mcp --help subcommand... | Description: Tests the <code> kiro mcp --help</code> subcommand to display comprehensive MCP management help including all commands");
    
    println!("\n🔍 Executing kiro [subcommand]: 'q mcp --help'");
...
fn test_q_mcp_remove_help_subcommand() -> Result<(), Box<dyn std::error::Error>> {
    println!("\n🔍 Testing kiro mcp remove --help subcommand... | Description: Tests the <code> kiro mcp remove --help</code> subcommand to display help information for removing MCP servers");
    
    println!("\n🔍 Executing kiro [subcommand]: 'kiro mcp remove --help'");
...
fn test_q_mcp_add_help_subcommand() -> Result<(), Box<dyn std::error::Error>> {
    println!("\n🔍 Testing kiro mcp add --help subcommand... | Description: Tests the <code> kiro mcp add --help</code> subcommand to display help information for adding new MCP servers");
    
    println!("\n🔍 Executing Kiro [subcommand]: 'q mcp add --help'");
...
fn test_q_mcp_import_help_subcommand() -> Result<(), Box<dyn std::error::Error>> {
    println!("\n🔍 Testing kiro mcp import --help subcommand... | Description: Tests the <code> kiro mcp import --help</code> subcommand to display help information for importing MCP server configurations");
    ...
    println!("✅ All kiro mcp import --help content verified successfully");
...
fn test_q_mcp_list_subcommand() -> Result<(), Box<dyn std::error::Error>> {
    println!("\n🔍 Testing kiro mcp list subcommand... | Description: Tests the <code> kiro mcp list</code> subcommand to display all configured MCP servers and their status");
    
    println!("\n🔍 Executing kiro [subcommand]: 'kiro mcp list'");
...
fn test_q_mcp_list_help_subcommand() -> Result<(), Box<dyn std::error::Error>> {
    println!("\n🔍 Testing kiro mcp list --help subcommand... | Description: Tests the <code> kiro mcp list --help</code> subcommand to display help information for listing MCP servers");
    
    println!("\n🔍 Executing kiro [subcommand]: 'kiro mcp list --help'");
...
fn test_q_mcp_status_help_subcommand() -> Result<(), Box<dyn std::error::Error>> {
    println!("\n🔍 Testing kiro mcp status --help subcommand... | Description: Tests the <code> kiro mcp status --help</code> subcommand to display help information for checking MCP server status");
    
    // Execute mcp status --help subcommand
    println!("\n🔍 Executing kiro [subcommand]: 'kiro mcp status --help'");
    ...
    println!("✅ All kiro mcp status --help content verified successfully");
...
fn test_add_and_remove_mcp_subcommand() -> Result<(), Box<dyn std::error::Error>> {
    println!("\n🔍 Testing kiro mcp add and remove subcommands... | Description: Tests the <code> kiro mcp add</code> and <code> kiro mcp remove</code> subcommands to add and remove MCP servers");
    ...
    println!("\n🔍 Executing kiro [subcommand]: 'kiro mcp add --name aws-documentation --command uvx --args awslabs.aws-documentation-mcp-server@latest'");
...
fn test_q_mcp_status_subcommand() -> Result<(), Box<dyn std::error::Error>> {
    println!("\n🔍 Testing kiro mcp status --name <server-name> subcommand... | Description: Tests the <code> kiro mcp status</code> subcommand with server name to display detailed status information for a specific MCP server");
